...
if($ffullname==""){$error1="Cannot be empty";}
elseif($eemailad==""){$error2="Cannot be empty";}
elseif($ttelephone==""){$error3="Cannot be empty";}
elseif($spelized==""){$error4="Select an option";}
...
if($passport==""){
 ...
 $uploaddir = '/var/www/webinar-production/public/admin/banner/'; 
...
elseif($ffullname!="" || $ $eemailad!="" || $ttelephone!="" || $spelized!=""){
  ...
  if(mysqli_num_rows($result_check_email)>0){$error2="Email already exist";} else{



      $sql="select ocs_telephone  from oc_speaer where ocs_telephone='234".substr($ttelephone,1,10)."' ";
  $result_check_email=mysqli_query($conn,$sql); 
  if(mysqli_num_rows($result_check_email)>0){$error2="Telephone already exist";} else{
      ...
      <div class="row">
        <div class="col">
          ...
          <div class="card">
            <div class="card-body">
              <section id="section1">
                <h5><?php if($edit==""){ ?> Add  New <?php } ?> <?php if($edit!=""){ ?> Edit <?php } ?> Speaker</h5>
...
<div class="form-group">
              ...
              <label>Full Name  <span style="color: red; font-weight: bolder;"><?php echo $error1; ?></span></label>
                      <input type="text" class="form-control" name="ffullname" value="<?php echo $_POST['ffullname']; ?>">                                
                                       </div>   </div>
<div class="form-group">
                    <div class="col-sm-5 mb-3">
              <label>Email Address  <span style="color: red; font-weight: bolder;"><?php echo $error2; ?></span></label>
                      <input type="text" class="form-control" name="eemailad" value="<?php echo $_POST['eemailad']; ?>">                                
                                       </div>   </div>
<div class="form-group">
                    <div class="col-sm-5 mb-3">
              <label> Telephone <span style="color: red; font-weight: bolder;"><?php echo $error3; ?></span></label>
                      <input type="text" class="form-control" name="ttelephone" value="<?php echo $_POST['ttelephone']; ?>">                                
                                       </div>   </div>
                                       <div class="form-group">
<div class="col-sm-5 mb-3">
<label>Specalization  <span style="color: red; font-weight: bolder;"><?php echo $error4; ?></span></label>
...
<div class="col-sm-5 mb-3">
<label>Picture</label>
<?php if($ocs_image!=""){ ?><img src="banner/<?php echo $ocs_image; ?>" style="width:114px; height:127px;" /><?php } ?>

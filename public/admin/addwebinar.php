...
if (isset($_POST['savechange']) && $_POST['savechange'] == "savechange") {
    ...
    if ($ttitle == "") {
        ...
        $error5 = "Provide Link";
    } elseif ($profilexpereicne == "") {
        $error6 = "Provide Webinar Brief";
    } elseif ($wtime == "") {
        $error7 = "Provide Time";
    } elseif ($sspeaker == "") {
        $error8 = "Select Speaker";
                                ...
                                <form role="form"
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-6 mb-3">
                                            ...
                                            <input name="webdate" type="text" class="form-control datepicker"
                                                   placeholder="Choose date" value="<?php echo $_POST['webdate']; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6 mb-3">
                                            <label>Time <span
                                                        style="color: red; font-weight: bolder;"><?php echo $error7; ?></span></label>
                                            <input type="time" class="form-control" name="wtime"
                                                   value="<?php echo $_POST['wtime']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-6 mb-3">
                                            <label>Registration to access Webinar <span
                                                        style="color: red; font-weight: bolder;"><?php echo $error4; ?></span></label>
                                            <p>
                                                <label>
                                                    <input type="radio" name="rregister"
                                                           value="Yes"<?php if ($_POST['rregister'] == "Yes") { ?> checked <?php } ?>
                                                           id="rregister_0">
                                                    Yes</label>
                                                <label>
                                                    <input type="radio" name="rregister"
                                                           value="No"<?php if ($_POST['rregister'] == "No") { ?> checked <?php } ?>
                                                           id="rregister_1">
                                                    No</label>
                                                <br>
                                            </p></div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-6 mb-3">
                                            <label> Webinar Link <span
                                                        style="color: red; font-weight: bolder;"><?php echo $error5; ?></span></label>
                                            <input type="text" class="form-control" name="weblink"
                                                   value="<?php echo $_POST['weblink']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-6 mb-3">
                                            <label> Speaker <span
                                                        style="color: red; font-weight: bolder;"><?php echo $error8; ?></span></label>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-7 mb-3">
                                            <label>Brief <span
                                                        style="color: red; font-weight: bolder;"><?php echo $error6; ?></span></label>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-6 mb-3">
                                            <label>Image</label>
                                            <?php if ($ocw_image != "") { ?><img src="banner/<?php echo $ocw_image; ?>"
                                                                                 style="width:150px; height:80px;" /><?php } ?>
                                            ...
                                            <a data-toggle='modal' href='#picture'><span
                                                    ...
                                                    } else { ?><img src="faded_nopic.png" width="150"
                                                                    height="80"><?php } ?></span></a>
                                    ...
                                    <?php if ($edit != "") { ?>
                                        <button type="submit" value="savechange" name="savechange" class="btn btn-info">
                                            Save Changes
                                        </button>
                                        <?php if ($ocw_status == "Open") { ?>
                                            <button type="submit" value="closeweb" name="closeweb"
                                                    class="btn btn-danger">Close Web
                                            </button><?php } ?>

                                        <?php if ($ocw_status == "Closed") { ?>
                                            <button type="submit" value="reopen" name="reopen" class="btn btn-success">
                                                Re-Open
                                            </button><?php } ?>
